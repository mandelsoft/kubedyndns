...
import (
	...
	coredns "github.com/mandelsoft/kubedyndns/client/informers/externalversions/coredns"
...
func (f *sharedInformerFactory) Coredns() coredns.Interface {
	return coredns.New(f, f.namespace, f.tweakListOptions)
}
