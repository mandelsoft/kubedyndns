...
import (
	v1alpha1 "github.com/mandelsoft/kubedyndns/client/clientset/versioned/typed/coredns/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeCorednsV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeCorednsV1alpha1) RESTClient() rest.Interface {
