...
func (c *FakeCoreDNSEntries) UpdateStatus(ctx context.Context, coreDNSEntry *v1alpha1.CoreDNSEntry, opts v1.UpdateOptions) (*v1alpha1.CoreDNSEntry, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(corednsentriesResource, "status", c.ns, coreDNSEntry), &v1alpha1.CoreDNSEntry{})
